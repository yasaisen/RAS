            ...
            <div class="content">
                ...
                <div style="background-color: white; border-style:dashed; border-color:rgb(114, 151, 173); padding:5px; border-radius:20px; 
                    ...
                    <div style="font-family:'Times New Roman','標楷體';">
                        <div>
                            <form id="" name="personal_info_update" action="./personal_info_update2.php" method="POST">
                                <p style="font-size:30px"><b>確認個人資料修改</b><hr style="border: 2px solid black;"/></p>
                                <p>姓名：
                                    <?php echo $_SESSION['accountName'];?> 
                                </p>
                                <p>帳號：
                                    <?php echo $_SESSION['new_account'];?> 
                                </p>
                                <p>密碼：
                                    <?php echo $_SESSION['new_password'];?> 
                                </p>
                                <p>電話：
                                    <?php echo $_SESSION['new_phone'];?>
                                </p>
                                <div> 
                                    <center><button class="attendance_record_page_btn" type="submit" style=" "><font style="vertical-align: inherit;">確認</font></button><center>    
                                </div>
                            </form>
                            <center><button class="attendance_record_page_btn" type="submit" style="margin-top:10px"><font style="vertical-align: inherit;" onclick="location.href='./personal_info.php'">取消</font></button><center>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="./personal_info2_insert_patient.php" method="post">
